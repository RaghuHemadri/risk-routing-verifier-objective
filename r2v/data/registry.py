...
Usage:
    ...
    run_id = make_run_id("swebench", "openai", "gpt-4o")
    ...
    # Downstream — query
    registry = DataRegistry()
    runs = registry.query(benchmark="swebench", model="gpt-4o")
...
def make_run_id(
    ...
    *,
    ...
    Returns:
        e.g. "webarena_openai_gpt-4o_20260218T210012"
             "swebench_anthropic_claude-3-5-sonnet_20260219T083045_noisy"
    """
...
class DataRegistry:
    ...
    # In train_policy.py:
    registry = DataRegistry()
    manifests = registry.query(benchmark="swebench", status="done")
